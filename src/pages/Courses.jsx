...
export default function Courses() {
  ...
  const addDay = () => {
    ...
    setForm({
      ...
      days: [
        ...
        {
          phase_number: 1,
          week_number: Math.ceil(n / 7),
          day_number: n,
          title: `Ngày ${n} (Tuần ${Math.ceil(n / 7)})`,
          exercises: [],
        },
      ],
    });
  ...
  const addExerciseToDay = (dIdx) => {
    const d = [...form.days];
    d[dIdx].exercises.push({ title: "", video_url: "" });
    setForm({ ...form, days: d });
  };
  const updateExerciseDetail = (dIdx, eIdx, field, value) => {
    const d = [...form.days];
    d[dIdx].exercises[eIdx][field] = value;
    setForm({ ...form, days: d });
  };
